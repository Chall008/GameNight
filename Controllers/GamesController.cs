...
namespace GameNight.Controllers
{
    ...
    public class GamesController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutGame(int id, Game game)
        {
            ...
            {
                //creates a bad request respone the responds to a 401 code
        ...
        public async Task<ActionResult<Game>> PostGame(Game game)
        {
            ...
            //if the min number of players is less than 2
            //  then... return some kind of error to user
            //          and dont do any more of this code.
            // IMPLEMENT A GUARD CLAUSE:
            //   if i take this path i will never get out
            //    no danger of running into the code below
            if (game.MinimumPlayers < 2)
            {
                //creates a bad request respone the responds to a 401 code
